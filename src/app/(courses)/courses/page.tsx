      ...
      <Main>
        ...
        >
          <TabsContent value='overview' className='space-y-4'>
            <div className="bg-[url('/img-bg-home.png')] bg-no-repeat bg-cover h-[20rem] flex flex-col justify-center items-center text-center w-full bg-zinc-50 mb-5">
              <div className="flex flex-col justify-center items-center text-center w-full">
                <p className="text-4xl lg:text-4xl xl:text-6xl font-bold mt-6">Kho học liệu</p>
                <p className="text-1xl lg:text-1xl xl:text-2xl mt-4 text-secondaryTextColor">
                  Thư viện cung cấp nguồn tài nguyên học tập đa dạng và chất lượng cao
                </p>
            ...
            <div className="grid grid-cols-10 gap-4">
              <div className="col-span-10 md:col-span-10 lg:col-span-5 xl:col-span-7">
                <div className='font-semibold leading-none tracking-tight mb-3 mt-5'>Nội dung liên quan</div>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      ...
                      <p className="text-gray-700 text-sm">
                        This is a description inside the card body. It provides more details about the content.
                      </p>
                    </CardContent>
                  </Card>
                  <Card>
              ...
              <div className="col-span-10 md:col-span-10 lg:col-span-5 xl:col-span-3 pl-4 border-l">
                <div className='font-semibold leading-none tracking-tight mb-3 mt-5'>Hoạt động gần đây</div>
